...
## Development environment and release process
 ...
 - create virtualenv with Flask and Sentinel installed into it (latter is installed in
...
install it (`pip install sentinel_backend.tar.gz`), ensure that configuration file exists and
`SENTINEL_BACKEND_SETTINGS` environment variable points to it, ensure that user has access to the
