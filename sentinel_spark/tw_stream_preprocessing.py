...
twitter_mentions_cleaned = kafka_stream.map(lambda x: to_mention(x)) \
    .map(lambda x: clean_mention_text(x, clean_comment_text))
twitter_mentions_enriched = twitter_mentions_cleaned \
